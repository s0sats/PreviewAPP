...
public class Constant extends ConstantBaseApp {
    ...
    public static void refreshUrl() {
        ...
        String HTTPS = "https://";
        String PREFIX_PRJ001 = "/ws/prj001";
        WS_GETCUSTOMERS = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_get_customer.ws";
        WS_GET_CUSTOMERS_SITE_LICENSE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_get_customer_site.ws";
        WS_GETSESSION = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_get_session.ws";
        ...
        WS_LOGOUT = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_logout.ws";
        WS_SO_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_so.ws";
        WS_SO_SERVICE_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_pack_service_list_app_2.ws";
        WS_SO_SERVICE_EDIT_GET = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_pack_service_edit_get.ws";
        WS_SO_SERVICE_EDIT_SET = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_pack_service_edit_set.ws";
        WS_SO_SERVICE_REMOVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_pack_service_cancel_app.ws";
        WS_SO_CLIENT_LIST = HTTPS + WS_HOST + PREFIX_PRJ001 + "/sm_order/server_client.ws";
        WS_SO_FAVORITE_LIST = HTTPS + WS_HOST + PREFIX_PRJ001 + "/sm_order/server_main.ws";
        WS_SO_CREATION = HTTPS + WS_HOST + PREFIX_PRJ001 + "/sm_order/server_save_so.ws";
        WS_SO_PRODUCT_EVENT_CANCEL = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_product_event_cancel.ws";
        WS_SO_NEXT_ORDERS = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_to_be_executed.ws";
        WS_SO_CREATE_ROOM = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_create_room.ws";
        WS_SO_STATUS_CHANGE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_change_status.ws";
        WS_SO_PRIROTY_CHANGE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_change_priority.ws";
        WS_USER_LIST_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/wg/server_user_list.ws";
        WS_SO_SAVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_save_so.ws";
        WS_SO_PACK_SERVICE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_pack_service_new_app_2.ws";
        WS_AP_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_ap.ws";
        WS_AP_SAVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_save_ap.ws";
        WS_SERIAL_SAVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_save_serial.ws";
        WS_IO_SERIAL_PROCESS_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_product_serial.ws";
        WS_IO_SERIAL_PROCESS_DOWNLOAD = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_product_serial_obj.ws";
        WS_IO_MOVE_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_move.ws";
        WS_IO_INBOUND_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_inbound.ws";
        WS_IO_OUTBOUND_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_outbound.ws";
        WS_IO_MOVE_DOWNLOAD = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_move_obj.ws";
        WS_IO_MOVE_SAVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_move_save.ws";
        WS_IO_INBOUND_DOWNLOAD = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_inbound_obj.ws";
        WS_IO_OUTBOUND_DOWNLOAD = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_outbound_obj.ws";
        WS_IO_MASTER_DATA = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_master_data.ws";
        WS_IO_FROM_OUTBOUND_SEARCH = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_outbound_search.ws";
        WS_IO_INBOUND_HEADER_SAVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_inbound_save.ws";
        WS_IO_OUTBOUND_HEADER_SAVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_outbound_save.ws";
        WS_IO_ADDRESS_SUGGESTION = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_address_suggestion.ws";
        WS_IO_BLIND_SAVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/io/server_blind_save.ws";
        ...
        WS_TICKET_SAVE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/tk/server_ticket_set.ws";
        WS_NEXT_TICKET = HTTPS + WS_HOST + PREFIX_PRJ001 + "/tk/server_ticket_next.ws";
        WS_TICKET_DOWNLOAD_CLIENT_CONTRACT = HTTPS + WS_HOST + PREFIX_PRJ001 + "/tk/server_ticket_search.ws";
        WS_TICKET_GET_WORKGROUP_LIST = HTTPS + WS_HOST + PREFIX_PRJ001 + "/tk/server_workgroup.ws";
        WS_TICKET_SERVER_MAIN_USER = HTTPS + WS_HOST + PREFIX_PRJ001 + "/tk/server_main_user.ws";
        WS_TICKET_DOWNLOAD_SEARCH_NOT_FOCUS = HTTPS + WS_HOST + PREFIX_PRJ001 + "/tk/server_ticket_search_not_focus.ws";
        WS_TICKET_CREATION = HTTPS + WS_HOST + PREFIX_PRJ001 + "/tk/server_ticket_create.ws";
        WS_DOWNLOAD_NOT_FOCUS_AND_HISTORIC = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_open_without_focus_and_historic.ws";
        WS_ENABLE_NFC = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_enable_nfc_auth.ws";
        WS_CANCEL_NFC = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_cancel_nfc_auth.ws";
        WS_SERVER_AUTH_USER = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_auth_user.ws";
        WS_SO_PACK_EXPRESSION = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_save_so_pack_express.ws";
        ...
        WS_SELECT_DESTINATION = HTTPS + WS_HOST + PREFIX_PRJ001 + "/trip/trip_destination_add.ws";
        WS_DESTINATION_CHANGE_STATUS = HTTPS + WS_HOST + PREFIX_PRJ001 + "/trip/trip_destination_status.ws";
        WS_TRIP_AVAILABLE_USERS = HTTPS + WS_HOST + PREFIX_PRJ001 + "/trip/trip_available_users.ws";
        WS_TRIP_SAVE_USER = HTTPS + WS_HOST + PREFIX_PRJ001 + "/trip/trip_user_action.ws";
        WS_TRIP_USER_POSITION = HTTPS + WS_HOST + PREFIX_PRJ001 + "/trip/user_position.ws";
        WS_TRIP = HTTPS + WS_HOST + PREFIX_PRJ001 + "/trip/trip.ws";
        ...
        WS_TRIP_UPDATE = HTTPS + WS_HOST + PREFIX_PRJ001 + "/trip/trip_full_update.ws";
        RESERVED_LIST_USER = HTTPS + WS_HOST + PREFIX_PRJ001 + "/server_sm_so_user.ws";
