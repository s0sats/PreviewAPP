...
public class WS_C_All_Read extends BaseWsIntentService {

    public WS_C_All_Read() {
        super("WS_C_All_Read");
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        try {
            ...
            WBR_C_All_Read.completeWakefulIntent(intent);
        }

    }

    private void processC_All_Read(String json_param) {

        Gson gson = new GsonBuilder().serializeNulls().create();
        //
        ArrayList<Chat_C_All_Delivered_Read> allReads =
                gson.fromJson(
                        json_param,
...
//            Log.d("ALL_DE_RE", " READ " + read.getMsg_code());
        ...
        //
        //ToolBox_Inf.sendBRChat(getApplicationContext(), Constant.CHAT_BR_TYPE_MSG_ALL_READ);
