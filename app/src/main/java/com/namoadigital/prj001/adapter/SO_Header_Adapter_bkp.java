...
public class SO_Header_Adapter_bkp extends BaseAdapter {
    ...
    public SO_Header_Adapter_bkp(Context context, int resource, List<HMAux> source, String config_type) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //SO EXPRESS
        LinearLayout ll_so_express = (LinearLayout) convertView.findViewById(R.id.so_header_cell_ll_express_ret);
        //
