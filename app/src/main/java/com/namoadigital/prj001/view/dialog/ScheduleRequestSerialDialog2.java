...
public class ScheduleRequestSerialDialog2 extends AlertDialog {
    private Context context;
    private HMAux  hmAux_Trans;
    private String mResource_Code;
    private String mResourceName = "schedule_request_serial_dialog";
    private MD_Schedule_Exec auxSchedule;
    //
    ...
    private String getProductInfo() {
        String prodId = auxSchedule.getProduct_id();
        String prodDesc = auxSchedule.getProduct_desc();
    ...
    private boolean isSerialOptional() {
        return auxSchedule.getRequire_serial() == 0
                && auxSchedule.getRequire_serial_done() == 0;
    }

    private void setConfig() {
        rdoYes.setChecked(true);
        //
        if( auxSchedule.getRequire_serial() ==  1
            || auxSchedule.getRequire_serial_done() == 1
        ){
    ...
    public MD_Schedule_Exec getAuxSchedule() {
        return auxSchedule;
    }
