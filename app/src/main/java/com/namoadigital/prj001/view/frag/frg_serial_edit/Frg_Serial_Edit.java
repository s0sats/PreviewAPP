...
//    private String sql_ss_class;
    ...
    public interface I_Frg_Serial_Edit {
        ...
        void onAddOrRemoveControlSS(SearchableSpinner ss, boolean add);
...
//        );
    ...
    public static List<String> getFragTranslationsVars() {
        ...
        //
        transListFrag.add("alert_class_serial_validation_ttl");
        transListFrag.add("alert_class_serial_invalid_msg");
        //
