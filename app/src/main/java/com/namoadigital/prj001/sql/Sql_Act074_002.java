...
public class Sql_Act074_002 implements Specification {
    ...
    //
    public Sql_Act074_002(long customer_code, String site_logged, int user_focus) {
    ...
    //
    public Sql_Act074_002(long customer_code, String site_logged, int user_focus, List<String> ticket_ids) {
        this.customer_code = customer_code;
        this.site_logged = site_logged;
        this.user_focus = user_focus;
        serial_filter = "";
    ...
    public Sql_Act074_002(long customer_code, String site_logged, long ticketProductCode, long ticketSerialCode) {
        this.customer_code = customer_code;
        this.site_logged = site_logged;
