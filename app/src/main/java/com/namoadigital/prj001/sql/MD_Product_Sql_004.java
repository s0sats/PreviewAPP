...
public class MD_Product_Sql_004 implements Specification {
    ...
    public MD_Product_Sql_004(long customer_code) {
    ...
    public String toSqlQuery() {
        ...
        return sb
                .append(" SELECT\n" +
                        ...
                        "   and p."+MD_ProductDao.SKETCH_URL+" is not null\n" +
                        "   and p."+MD_ProductDao.SKETCH_URL_LOCAL+" = ''")
                .append(";")
