...
/**
 * Created by dluche on 06/07/17.
 *
 * Max + 1 , retonar next_tmp
 */
...
public class SM_SO_Service_Exec_Task_Sql_003 implements Specification {
    ...
    public SM_SO_Service_Exec_Task_Sql_003(long customer_code, int so_prefix, int so_code, int price_list_code, int pack_code, int pack_seq, int category_price_code, int service_code, int service_seq, int exec_tmp) {
