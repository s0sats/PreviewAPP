...
public class TK_Ticket_Justify_Sql_Img_Download_002 implements Specification {
    ...
    public TK_Ticket_Justify_Sql_Img_Download_002(long customer_code, String ticket_prefix, String ticket_code, String not_executed_photo_local) {
    ...
    public String toSqlQuery() {
        ...
        return sb
                .append(" UPDATE " + TK_TicketDao.TABLE +"\n" +
                        " SET not_executed_photo_local =  '"+ not_executed_photo_local +"'\n" +
                        " WHERE\n" +
