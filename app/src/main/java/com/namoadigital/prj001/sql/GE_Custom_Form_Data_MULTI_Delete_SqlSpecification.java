...
public class GE_Custom_Form_Data_MULTI_Delete_SqlSpecification implements Specification {
    ...
    public GE_Custom_Form_Data_MULTI_Delete_SqlSpecification(String s_customer_code, String s_formtype_code, String s_form_code, String s_formversion_code, String s_form_data) {
    ...
    public String toSqlQuery() {
        ...
        return sb
                ...
                .append(" and ")
                .append(" (")
                .append(GE_Custom_Form_DataDao.CUSTOM_FORM_DATA)
                .append(" ='")
                .append(s_form_data)
                .append("'")
                .append(" )")
