 ...
 *
 * Max + 1 , retorna next tmp
 */

public class SM_SO_Service_Exec_Sql_003 implements Specification {
    ...
    public SM_SO_Service_Exec_Sql_003(long customer_code, int so_prefix, int so_code, int price_list_code, int pack_code, int pack_seq, int category_price_code, int service_code, int service_seq) {
    ...
    public String toSqlQuery() {
        ...
        return sb
                .append(" SELECT\n" +
                        "     IFNULL(max(s.exec_tmp),100) + 1 "+NEXT_TMP+" \n" +
                        " FROM\n" +
