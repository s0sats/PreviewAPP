 ...
 * OS/IO
 */
class SqlAct005TagList002 (private val context: Context,
...
//            formFilter += "\n and gcdl.${GE_Custom_Form_LocalDao.SITE_CODE} = $siteCode "
        ...
        if (ConstantBaseApp.PREFERENCE_HOME_ONLY_MY_ACTIONS_OPTION.equals(focusFilter)) {
    ...
    override fun toSqlQuery(): String {
        ...
        val toString = sb.append(
                """
select sum(qty) qty, max(update_required)  update_required
from(
