...
public class GE_Custom_Form_Data_MULTI_Token_SqlSpecification implements Specification {
    ...
    public GE_Custom_Form_Data_MULTI_Token_SqlSpecification(String token, String s_user_code, String s_customer_code) {
        this.token = token;
