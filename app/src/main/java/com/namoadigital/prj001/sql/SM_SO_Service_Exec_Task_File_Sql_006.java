...
/**
 * Created by dluche on 1907/17.
 *
 * Seleciona task file especifica
 */

public class SM_SO_Service_Exec_Task_File_Sql_006 implements Specification {
    ...
    public SM_SO_Service_Exec_Task_File_Sql_006(long customer_code, int so_prefix, int so_code, int price_list_code, int pack_code, int pack_seq, int category_price_code, int service_code, int service_seq, long exec_tmp, long task_tmp, long file_tmp) {
