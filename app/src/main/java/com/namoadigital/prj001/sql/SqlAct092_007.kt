        ...
        var s = """SELECT
                    ...
                    LEFT JOIN    
                        (SELECT
                           ...
                           null ${TK_Ticket_StepDao.STEP_DESC} ,
                    ...
                    WHERE                     
                          ...
                          and t.${TK_TicketDao.USER_FOCUS} = 0  
                          and t.${TK_TicketDao.OPEN_PRODUCT_CODE} = $productCode 
                          and '$serialId' is null or t.${TK_TicketDao.OPEN_SERIAL_ID}  = '$serialId'     
                          and t.${TK_TicketDao.TICKET_STATUS} in( '${ConstantBaseApp.SYS_STATUS_DONE}',
