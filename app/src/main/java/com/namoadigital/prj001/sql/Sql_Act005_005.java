 ...
 *
 * Query da Act005.
 * Seleciona todas S.O com sync_required eque o usr pode ter alguma ação, incluindo
 * o status offine WAITING_SYNC.
 * "Filtro Minhas Pendencias"*
 */

public class Sql_Act005_005 implements Specification {
    ...
    public Sql_Act005_005(long customer_code, String site_code, int zone_code) {
