...
public class Sql_Act011_002 implements Specification {
    ...
    public String toSqlQuery() {
        ...
        return sb
                ...
                .append(";")
                .append("CUSTOMER_CODE#CUSTOM_FORM_TYPE#CUSTOM_FORM_CODE#CUSTOM_FORM_VERSION#CUSTOM_FORM_DATA#CUSTOM_FORM_SEQ#CUSTOM_FORM_DATA_TYPE#CUSTOM_FORM_DATA_SIZE#CUSTOM_FORM_DATA_MASK#CUSTOM_FORM_DATA_CONTENT#CUSTOM_FORM_LOCAL_LINK#CUSTOM_FORM_ORDER#PAGE#REQUIRED#AUTOMATIC#COMMENT#TXT_VALUE;")
                .toString();
    }
}
