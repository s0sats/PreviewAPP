 ...
 *
 */
public class IO_Inbound_Item_Sql_005 implements Specification {
    private long customer_code;
    private int inbound_prefix;
    private int inbound_code;
    private int update_required;

    public IO_Inbound_Item_Sql_005(long customer_code, int inbound_prefix, int inbound_code, int update_required) {
