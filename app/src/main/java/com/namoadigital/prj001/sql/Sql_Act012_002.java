 ...
 *
 * Query que seleciona a qtd  S.Os pendentes
 */

public class Sql_Act012_002 implements Specification {
    ...
    public Sql_Act012_002(long s_customer_code, HMAux label_translation) {
    ...
    public String toSqlQuery() {
        ...
        return sb
                .append( "SELECT\n" +
                        "     count(1) "+PENDING_QTY+",\n " +
                        "    '"+label_translation.get(Act012_Main.LABEL_TRANS_OS)+"' "+TYPE+" ,\n " +
                        "    '"+Constant.MODULE_SO+"' "+MODULE+"\n " +
                        " FROM\n" +
                        SM_SODao.TABLE + " S\n" +
                        " WHERE\n" +
