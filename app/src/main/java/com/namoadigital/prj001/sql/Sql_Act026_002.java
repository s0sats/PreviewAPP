...
public class Sql_Act026_002 implements Specification {
    ...
    public Sql_Act026_002(long customer_code, String site_code, int zone_code, String product_code, String serial_id, boolean filter_only_avaliable) {
