...
public class Sql_WS_TK_Ticket_Save_006 implements Specification {
    ...
    public Sql_WS_TK_Ticket_Save_006(long customer_code, long ticket_prefix, long ticket_code, int step_code,int ticket_seq_tmp, int update_required) {
