...
public class GE_Custom_Form_Data_MULTI_Novos_SqlSpecification implements Specification {
    ...
    public GE_Custom_Form_Data_MULTI_Novos_SqlSpecification(String s_user_code, String s_customer_code) {
