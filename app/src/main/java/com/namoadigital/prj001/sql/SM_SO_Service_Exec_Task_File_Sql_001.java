...
public class SM_SO_Service_Exec_Task_File_Sql_001 implements Specification {
    ...
    public SM_SO_Service_Exec_Task_File_Sql_001(long customer_code, int so_prefix, int so_code, int price_list_code, int pack_code, int pack_seq, int category_price_code, int service_code, int service_seq, int exec_code, int task_code, int file_code) {
