...
public class IO_Outbound_Item_Sql_006 implements Specification {
    ...
    public IO_Outbound_Item_Sql_006(long customer_code, int outbound_prefix, int outbound_code, int outbound_item) {
