...
public class SM_SO_Service_Sql_002 implements Specification {
    ...
    public SM_SO_Service_Sql_002(long customer_code, int so_prefix, int so_code, int price_list_code, int pack_code, int pack_seq) {
