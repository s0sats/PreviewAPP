...
public class Sql_Act027_002_bkp implements Specification {
    ...
    public Sql_Act027_002_bkp(long customer_code, int so_prefix, int so_code, String user_code, String site_code, int zone_code, boolean filter_only_avaliable) {
    ...
    public String toSqlQuery() {
        ...
        return
                sb
                .append(" SELECT\n" +
                        "   CASE WHEN TTT.SO_STATUS IN ('"+ Constant.SYS_STATUS_PENDING+"','"+ Constant.SYS_STATUS_PROCESS+"') AND TTT.status = '"+ Constant.SYS_STATUS_PENDING+"' AND TTT.exec_type = '"+ Constant.SO_SERVICE_TYPE_YES_NO+"' AND TTT.QTY_DONE < TTT.qty AND TTT.PARTNER_RESTRICTION IN (-1,1)\n" +
                        "       THEN\n" +
                        "        1\n" +
                        "       ELSE\n" +
                        "        0\n" +
