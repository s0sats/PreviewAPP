...
public class GE_Custom_Form_Data_Field_MULTI_Pendente_SqlSpecification implements Specification {
    ...
    public GE_Custom_Form_Data_Field_MULTI_Pendente_SqlSpecification(String s_user_code, String s_customer_code) {
