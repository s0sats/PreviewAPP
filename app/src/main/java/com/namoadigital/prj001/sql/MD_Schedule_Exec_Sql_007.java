 ...
 * LUCHE - 26/03/2020
 *
 * Query que busca o form_data via dados do agendamentos
 */

public class MD_Schedule_Exec_Sql_007 implements Specification {
    private String  customer_code;
    private String schedule_prefix;
    private String schedule_code;
    private String schedule_exec;

    public MD_Schedule_Exec_Sql_007(String customer_code, String schedule_prefix, String schedule_code, String schedule_exec) {
