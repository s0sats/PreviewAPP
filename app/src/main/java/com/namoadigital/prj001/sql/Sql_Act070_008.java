...
/**
 * LUCHE 10/09/2020
 * Query que verifica se ticket possui algum form com pendencia de GPS
 */
public class Sql_Act070_008 implements Specification {
    private long customer_code;
    private int ticket_prefix;
    private int ticket_code;

    public Sql_Act070_008(long customer_code, int ticket_prefix, int ticket_code) {
