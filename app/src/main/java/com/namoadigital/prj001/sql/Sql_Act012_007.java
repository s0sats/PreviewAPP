...
public class Sql_Act012_007 implements Specification {
    ...
    public Sql_Act012_007(long customer_code, HMAux label_translation) {
    ...
    public String toSqlQuery() {
        ...
        return sb
                .append( "SELECT\n" +
                        "     count(1) "+PENDING_QTY+",\n " +
                        "    '"+label_translation.get(Act012_Main.LABEL_TRANS_IO_OUTBOUND)+"' "+TYPE+", \n " +
                        "    '"+Act012_Main.LABEL_TRANS_IO_OUTBOUND+"' "+MODULE+"\n " +
                        " FROM\n" +
                        IO_OutboundDao.TABLE +" s\n" +
                        " WHERE \n" +
