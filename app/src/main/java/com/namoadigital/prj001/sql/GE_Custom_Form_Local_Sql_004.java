...
/**
 * Created by DANIEL.LUCHE on 15/02/2017.
 */
...
public class GE_Custom_Form_Local_Sql_004 implements Specification {
    ...
    public GE_Custom_Form_Local_Sql_004(String s_customer_code, String s_formtype_code, String s_form_code, String s_formversion_code, String s_form_status) {
        this.s_customer_code = s_customer_code;
        this.s_formtype_code = s_formtype_code;
        this.s_form_code = s_form_code;
        this.s_formversion_code = s_formversion_code;
        this.s_form_data = s_formversion_code;
