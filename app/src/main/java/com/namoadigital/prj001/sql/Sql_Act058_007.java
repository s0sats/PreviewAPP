...
public class Sql_Act058_007 implements Specification {
    private long customer_code;

    public Sql_Act058_007(long customer_code) {
    ...
    public String toSqlQuery() {
        ...
        return sb.append("select m.*, p.zone_id , p.serial_id, p.local_id , p.product_desc, p.product_id, z.zone_id "+ IO_MoveDao.PLANNED_ZONE_ID + ", l.local_id "+ IO_MoveDao.PLANNED_LOCAL_ID+    "\n" +
                ...
                " where m.status IN (\"" + ConstantBaseApp.SYS_STATUS_DONE + "\",\"" + ConstantBaseApp.SYS_STATUS_CANCELLED + "\")\n" +
