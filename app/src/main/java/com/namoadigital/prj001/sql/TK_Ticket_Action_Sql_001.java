...
public class TK_Ticket_Action_Sql_001 implements Specification {
    private long customer_code;
    private int ticket_prefix;
    private int ticket_code;
    private int ticket_seq;

    public TK_Ticket_Action_Sql_001(long customer_code, int ticket_prefix, int ticket_code, int ticket_seq) {
