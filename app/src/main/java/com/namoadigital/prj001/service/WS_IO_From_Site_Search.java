...
import com.namoadigital.prj001.model.T_IO_From_Site_Search_Env;
...
public class WS_IO_From_Site_Search extends BaseWsIntentService {

    private HMAux hmAux_Trans = new HMAux();
    private String mModule_Code = Constant.APP_MODULE;
    private String mResource_Code = "0";
    private String mResource_Name = "ws_io_from_site_search";
    private Gson gson = new GsonBuilder().serializeNulls().create();

    public WS_IO_From_Site_Search() {
        super("ws_io_from_site_search");
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        try {
            ...
            WBR_IO_From_Site_Search.completeWakefulIntent(intent);
        }
    }
    ...
    private void processWsFromOutboundSearch(String from_site_code, String to_site_code, String transport_order) throws Exception {
        ...
        //
        T_IO_From_Site_Search_Env env = new T_IO_From_Site_Search_Env();
        //
        ...
        String resultado = ToolBox_Con.connWebService(
                Constant.WS_IO_FROM_OUTBOUND_SEARCH,
                gson.toJson(env)
        );
        //
