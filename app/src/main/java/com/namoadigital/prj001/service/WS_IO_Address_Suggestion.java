...
public class WS_IO_Address_Suggestion extends BaseWsIntentService {

    private HMAux hmAux_Trans = new HMAux();
    private String mModule_Code = Constant.APP_MODULE;
    private String mResource_Code = "0";
    private String mResource_Name = "ws_io_address_suggestion";
    private Gson gson = new GsonBuilder().serializeNulls().create();

    public WS_IO_Address_Suggestion() {
        super("WS_IO_Address_Suggestion");
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        try {
            ...
            WBR_IO_Address_Suggestion.completeWakefulIntent(intent);
        }
    }

    private void processWsAddressSuggestion(String site_code, String product_code) throws Exception {
        //Seleciona traduções
        loadTranslation();
        //
        ...
        String resultado = ToolBox_Con.connWebService(
                Constant.WS_IO_ADDRESS_SUGGESTION,
                gson.toJson(env)
        );
        //
