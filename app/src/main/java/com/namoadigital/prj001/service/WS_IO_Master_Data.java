...
public class WS_IO_Master_Data extends BaseWsIntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        try {
            ...
            WBR_IO_Master_Data.completeWakefulIntent(intent);
        }
    }

    private void processWsIoMasterDataProcess(String site_code, String type, String action) throws Exception {
        //Seleciona traduções
        loadTranslation();
        //
        ToolBox_Inf.sendBCStatus(getApplicationContext(), "STATUS", hmAux_Trans.get("msg_sending_data"), "", "0");
        //
        T_IO_Master_Data_Env env = new T_IO_Master_Data_Env();
        //
