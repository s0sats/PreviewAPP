...
class WsTripDestinationStatusChange: BaseWsIntentService("WsTripDestinationStatusChange", IntentServiceMode.UPLOAD_DATA()) {
        ...
        try {
            ...
            extras?.let {
                val request = Gson().fromJson(
                    it.getString(TripDestinationStatusChangeEnv.WS_BUNDLE_KEY),
                    TripDestinationStatusChangeEnv::class.java
                )
                processDestinationStatusChange(request)
            }
            //
        } catch (e: Exception) {
    ...
    private fun processDestinationStatusChange(request: TripDestinationStatusChangeEnv) {
            ...
            it.watchStatus(
                success = { response ->
                    ...
                    response.data?.let { statusChanged ->
                        ...
                        //
                        val tripPositionDao = FsTripPositionDao(applicationContext)
