...
public class WS_IO_Serial_Process_Search extends IntentService {
    ...
    private String mResource_Name = "ws_io_serial_process_search";
    private Gson gson = new GsonBuilder().serializeNulls().create();

    public WS_IO_Serial_Process_Search() {
        super("WS_IO_Serial_Process_Search");
    }
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        try {
            ...
            processWsIoSerialProcess(site_code,product_code, serial_id, tracking);
            ...
            WBR_IO_Serial_Process_Search.completeWakefulIntent(intent);
        }
    }

    private void processWsIoSerialProcess(String site_code, String product_code, String serial_id, String tracking) throws Exception {
        //Seleciona traduções
        loadTranslation();
        //
        ToolBox_Inf.sendBCStatus(getApplicationContext(), "STATUS", hmAux_Trans.get("msg_sending_data"), "", "0");
        //
        T_IO_Serial_Process_Env env = new T_IO_Serial_Process_Env();
        //
        ...
        String resultado = ToolBox_Con.connWebService(
                Constant.WS_IO_SERIAL_PROCESS_SEARCH,
                gson.toJson(env)
        );
        //
