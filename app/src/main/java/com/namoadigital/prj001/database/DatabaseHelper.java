...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append(" create table if not exists [users] ([user_code] int not null, [user_nick] text not null COLLATE NOCASE, [email_p] text not null COLLATE NOCASE, [password] text not null COLLATE NOCASE, [nfc_code] text not null COLLATE NOCASE, [dtsync] text not null COLLATE NOCASE,  constraint pk_users primary key(user_code));");
            ...
            script.append(" create table if not exists [ev_customers] ([customer_code] int not null, [date_db_customer] text not null COLLATE NOCASE, constraint pk_list_customers primary key(customer_code));");
