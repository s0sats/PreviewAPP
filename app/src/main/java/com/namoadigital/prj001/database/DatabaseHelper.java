...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append(" create table if not exists [ev_user_customers] ([user_code] int not null, [customer_code] int not null, [customer_name] text not null COLLATE NOCASE, [translate_code] int not null, [language_code] text not null COLLATE NOCASE, [translate_desc] text not null COLLATE NOCASE, [nls_date_format] text not null COLLATE NOCASE, [keyuser] int not null, constraint pk_list_customers primary key(user_code,customer_code));");
