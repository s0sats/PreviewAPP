...
public class DatabaseHelperChat extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [ch_messages] ([msg_prefix] int not null, [msg_code] int not null, [tmp] int not null, [room_code] text not null COLLATE NOCASE,[msg_date] text not null COLLATE NOCASE,[msg_obj] text not null COLLATE NOCASE, [message_image_local] text DEFAULT '' COLLATE NOCASE,[msg_origin] text not null COLLATE NOCASE,[delivered]  int not null DEFAULT 0,[delivered_date] text COLLATE NOCASE,[read]  int not null DEFAULT 0,[read_date] text COLLATE NOCASE,[msg_pk] text COLLATE NOCASE,[user_code]  int not null ,[user_nick] text not null COLLATE NOCASE,[status_update] int not null DEFAULT 0 ,constraint pk_ch_messages primary key(msg_prefix,tmp));");
