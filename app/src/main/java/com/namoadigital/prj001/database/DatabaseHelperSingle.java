...
import static com.namoadigital.prj001.database.scripts.single.EVUserCustomerScriptKt.EV_USER_CUSTOMER_CREATE_SCRIPT;
...
public class DatabaseHelperSingle extends DatabaseBaseHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append(EV_USER_CUSTOMER_CREATE_SCRIPT);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        try{
            switch (oldVersion){
                ...
                case 13:
                    MigrationsSingleKt.getMigrationSingleV13().migrate(db);
                    break;
            }
        } catch (Exception e) {
