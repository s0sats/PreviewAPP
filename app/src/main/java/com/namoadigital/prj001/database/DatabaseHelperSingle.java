...
public class DatabaseHelperSingle extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [ev_users] ([user_code] int not null, [user_nick] text not null DEFAULT '' COLLATE NOCASE, [email_p] text not null DEFAULT '' COLLATE NOCASE, constraint pk_users primary key(user_code));");
            script.append("create table if not exists [ev_user_customers] ([user_code] int not null, [customer_code] int not null, [customer_name] text not null DEFAULT '' COLLATE NOCASE, [translate_code] int not null, [language_code] text not null DEFAULT '' COLLATE NOCASE, [translate_desc] text not null DEFAULT '' COLLATE NOCASE, [nls_date_format] text not null DEFAULT '' COLLATE NOCASE, [keyuser] int not null, [blocked] int not null, [session_app] text not null DEFAULT '' COLLATE NOCASE,[pending] int not null DEFAULT 0, [logo_url] text NOT NULL DEFAULT '' COLLATE NOCASE, constraint pk_list_customers primary key(user_code,customer_code));");
            ...
            script.append("create table if not exists [fcmmessages] ([fcmmessage_code] INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE, [customer] text not null DEFAULT '' COLLATE NOCASE, [type] text not null DEFAULT '' COLLATE NOCASE, [title] text not null DEFAULT '' COLLATE NOCASE, [msg_short] text not null DEFAULT '' COLLATE NOCASE, [msg_long] text not null DEFAULT '' COLLATE NOCASE, [module] text not null DEFAULT '' COLLATE NOCASE, [sender] text not null DEFAULT '' COLLATE NOCASE, [sync] text not null DEFAULT '' COLLATE NOCASE, [status] text not null DEFAULT '1' COLLATE NOCASE, [date_create] text not null DEFAULT '1900-01-01' COLLATE NOCASE, [date_create] int not null );");
            //
