...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("CREATE TABLE IF NOT EXISTS [md_product_serial_trackings]([customer_code] int not null,[product_code] int not null,[serial_code] int not null,[serial_tmp] int,[tracking] text not null COLLATE NOCASE,constraint [pk_md_product_serial_trackings] primary key([customer_code],[product_code],[serial_code],[tracking]));");
