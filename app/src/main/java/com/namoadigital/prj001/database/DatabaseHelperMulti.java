...
public class DatabaseHelperMulti extends DatabaseBaseHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [ge_custom_forms] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [require_signature] int not null, [require_location] int not null DEFAULT 0, [require_serial_done] int not null DEFAULT 0, [automatic_fill] text NOT NULL DEFAULT '' COLLATE nocase,[all_product] int not null DEFAULT 0, [all_site] int not null DEFAULT 0, [all_operation] int not null DEFAULT 0, constraint pk_forms primary key(customer_code,custom_form_type,custom_form_code,custom_form_version));");
            script.append("create table if not exists [ge_custom_form_fields] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [custom_form_seq] int not null, [custom_form_data_type] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_size] int, [custom_form_data_mask] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_content] text not null DEFAULT '' COLLATE NOCASE, [custom_form_local_link] text not null DEFAULT '' COLLATE NOCASE, [custom_form_order] int not null, [page] int not null, [required] int not null, [automatic] text not null DEFAULT '' COLLATE NOCASE, [comment] text not null DEFAULT '' COLLATE NOCASE, [require_photo_on_nc] text not null DEFAULT '' COLLATE NOCASE, constraint pk_form_fields primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_seq));");

            script.append("create table if not exists [ge_custom_forms_local]([customer_code] int NOT NULL, [custom_form_type] int NOT NULL, [custom_form_type_desc] text NOT NULL DEFAULT '' COLLATE nocase, [custom_form_code] int NOT NULL, [custom_form_version] int NOT NULL, [custom_form_desc] text NOT NULL DEFAULT '' COLLATE nocase, [custom_form_data] int NOT NULL, [custom_form_pre] text NOT NULL DEFAULT '' COLLATE nocase, [custom_form_status] text NOT NULL DEFAULT '' COLLATE nocase, [custom_form_data_serv] int , [custom_product_code] int NOT NULL, [custom_product_desc] text NOT NULL DEFAULT '' COLLATE nocase, [custom_product_id] text NOT NULL DEFAULT '' COLLATE nocase, [serial_id] text NOT NULL DEFAULT '' COLLATE nocase, [require_signature] int NOT NULL, [require_location] int not null DEFAULT 0, [require_serial_done] int not null DEFAULT 0,[automatic_fill] text NOT NULL DEFAULT '' COLLATE nocase, [schedule_date_start_format] text NOT NULL DEFAULT '' COLLATE NOCASE, [schedule_date_end_format] text NOT NULL DEFAULT '' COLLATE NOCASE,[schedule_date_start_format_ms] INT NOT NULL DEFAULT 0,[schedule_date_end_format_ms] INT NOT NULL DEFAULT 0, [require_serial] int not null DEFAULT 0, [allow_new_serial_cl] int not null DEFAULT 0, [all_product] int not null DEFAULT 0, [all_site] int not null DEFAULT 0, [all_operation] int not null DEFAULT 0, [site_code] int NOT NULL, [site_id] text NOT NULL DEFAULT '' COLLATE nocase, [site_desc] text NOT NULL DEFAULT '' COLLATE nocase, [io_control] int NOT NULL, [inbound_auto_create] int NOT NULL, [operation_code] int NOT NULL, [operation_id] text NOT NULL DEFAULT '' COLLATE nocase, [operation_desc] text NOT NULL DEFAULT '' COLLATE nocase, [local_control] int NOT NULL, [product_io_control] int NOT NULL, [site_restriction] int NOT NULL, [serial_rule] text COLLATE nocase, [serial_min_length] int, [serial_max_length] int,[schedule_comments] text COLLATE NOCASE , CONSTRAINT [pk_forms] PRIMARY KEY([customer_code], [custom_form_type], [custom_form_code], [custom_form_version], [custom_form_data]));");
            script.append("create table if not exists [ge_custom_form_fields_local] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [custom_form_data] int not null,[custom_form_data_serv] int, [custom_form_seq] int not null, [custom_form_data_type] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_size] int, [custom_form_data_mask] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_content] text not null DEFAULT '' COLLATE NOCASE, [custom_form_local_link] text not null DEFAULT '' COLLATE NOCASE, [custom_form_order] int not null, [page] int not null, [required] int not null, [automatic] text not null DEFAULT '' COLLATE NOCASE, [comment] text not null DEFAULT '' COLLATE NOCASE, [require_photo_on_nc] text not null DEFAULT '' COLLATE NOCASE, [custom_form_field_desc] text not null DEFAULT '' COLLATE NOCASE, constraint pk_form_fields primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_data,custom_form_seq));");
            ...
            script.append("create table if not exists [ge_custom_form_datas]( [customer_code] int NOT NULL, [custom_form_type] int NOT NULL, [custom_form_code] int NOT NULL, [custom_form_version] int NOT NULL, [custom_form_data] int NOT NULL, [custom_form_data_serv] int, [custom_form_status] text NOT NULL DEFAULT '' COLLATE nocase, [product_code] int NOT NULL, [serial_id] text NOT NULL DEFAULT '' COLLATE nocase, [date_start] text NOT NULL DEFAULT '' COLLATE nocase, [date_end] text NOT NULL DEFAULT '' COLLATE nocase, [user_code] int NOT NULL, [site_code] int NOT NULL, [operation_code] int NOT NULL, [signature] text DEFAULT '' COLLATE NOCASE, [signature_name] text DEFAULT '' COLLATE nocase, [token] text NOT NULL DEFAULT '' COLLATE nocase, [location_type] text DEFAULT '' COLLATE nocase, [location_lat] text DEFAULT '' COLLATE nocase, [location_lng] text DEFAULT '' COLLATE nocase, [so_prefix] int, [so_code] int, [zone_code] int, [local_code] int, CONSTRAINT [pk_form_datas] PRIMARY KEY([customer_code], [custom_form_type], [custom_form_code], [custom_form_version], [custom_form_data]));");
            ...
            script.append("create table if not exists [md_products] ([customer_code] int not null, [product_code] int not null, [product_id] text not null DEFAULT '' COLLATE NOCASE, [product_desc] text not null DEFAULT '' COLLATE NOCASE, [require_serial] int not null, [allow_new_serial_cl] int not null, [un] text COLLATE nocase, [sketch_code] int, [sketch_url] text COLLATE nocase, [sketch_url_local] text not null DEFAULT '' COLLATE nocase,[sketch_lines] int, [sketch_columns] int, [sketch_color] text COLLATE nocase,[flag_offline] int not null default 0,[local_control] int not null default 0, [io_control] int not null default 0, [serial_rule] text collate nocase, [serial_min_length] int, [serial_max_length] int, [site_restriction] int not null default 0, constraint pk_md_products primary key(customer_code, product_code));");
            ...
            script.append("create table if not exists [md_sites] ([customer_code] int not null, [site_code] int not null, [site_id] text not null DEFAULT '' COLLATE NOCASE,  [site_desc] text not null DEFAULT '' COLLATE NOCASE, [io_control] int not null default 0, [reason_code] int, [inbound_auto_create] int not null default 0, [in_allow_new_item] int not null default 0,[in_put_away_process] int not null default 0,[in_zone_code_conf] int,[in_local_code_conf] int,[in_done_automatic] int not null default 0,[out_allow_new_item] int not null default 0,[out_picking_process] int not null default 0,[out_zone_code_picking] int,[out_local_code_picking] int,[out_done_automatic] int not null default 0,constraint pk_md_sites primary key(customer_code, site_code));");
            ...
            script.append("create table if not exists [md_all_products] ([customer_code] int not null, [product_code] int not null, [product_id] text not null DEFAULT '' COLLATE NOCASE, [product_desc] text not null DEFAULT '' COLLATE NOCASE, [require_serial] int not null, [allow_new_serial_cl] int not null, [un] text COLLATE nocase, [sketch_code] int, [sketch_url] text COLLATE nocase, [sketch_url_local] text not null DEFAULT '' COLLATE nocase,[sketch_lines] int, [sketch_columns] int, [sketch_color] text COLLATE nocase,[flag_offline] int not null default 0,[local_control] int not null default 0, [io_control] int not null default 0, [serial_rule] text collate nocase, [serial_min_length] int, [serial_max_length] int, constraint pk_md_all_products primary key(customer_code, product_code));");
            script.append("create table if not exists [md_all_product_groups]( [customer_code] int not null,  [group_code] int not null, [recursive_code] int not null, [recursive_code_father] int, [group_id] text not null DEFAULT '' COLLATE NOCASE,  [group_desc] text not null DEFAULT '' COLLATE NOCASE,  constraint pk_md_all_product_groups primary key(customer_code, group_code));");
            ...
            //TABLES SO
            script.append("CREATE TABLE if not exists [sm_sos] ( [customer_code] int NOT NULL, [so_prefix] int NOT NULL, [so_code] int NOT NULL, [so_id] text NOT NULL, [so_scn] int NOT NULL, [so_desc] text , [product_code] int NOT NULL, [product_id] text NOT NULL COLLATE nocase, [product_desc] text NOT NULL COLLATE nocase, [serial_code] int NOT NULL, [serial_id] text NOT NULL COLLATE nocase, [category_price_code] int NOT NULL, [category_price_id] text NOT NULL, [category_price_desc] text NOT NULL, [segment_code] int NOT NULL, [segment_id] text NOT NULL, [segment_desc] text NOT NULL, [site_code] int NOT NULL, [site_id] text NOT NULL, [site_desc] text NOT NULL, [operation_code] int NOT NULL, [operation_id] text NOT NULL, [operation_desc] text NOT NULL, [contract_code] int NOT NULL, [contract_desc] text NOT NULL, [contract_po_erp] text, [contract_po_client1] text, [contract_po_client2] text, [contract_po_client3] text, [priority_code] int NOT NULL, [priority_desc] text NOT NULL, [status] text NOT NULL, [quality_approval_user] int,[quality_approval_user_nick] text, [quality_approval_date] text, [comments] text, [so_father_prefix] int, [so_father_code] int, [deadline] text, [origin] text NOT NULL, [client_type] text NOT NULL, [client_user] int, [client_code] int, [client_id] text, [client_name] text, [client_email] text, [client_phone] text, [client_approval_image] int, [client_approval_image_name] text, [client_approval_image_url] text,[client_approval_image_url_local] text, [client_approval_date] text, [client_approval_user] int, [client_approval_user_nick] text, [client_approval_type_sig] text, [client_so_id] text, [origin_change] text NOT NULL, [started_flag] int NOT NULL, [edit_origin] text, [edit_user] int, [edit_user_nick] text, [total_qty_service] int NOT NULL, [total_price] real NOT NULL,[add_inf1] text,[add_inf2] text,[add_inf3] text,[approve_budget] int NOT NULL default 0,[approve_client] int NOT NULL default 0, [update_required] int NOT NULL default 0, [approval_required] int NOT NULL default 0, [sync_required] int NOT NULL default 0, [log_date] text ,[token] text NOT NULL DEFAULT '' COLLATE nocase, PRIMARY KEY([customer_code],[so_prefix],[so_code]));");
            script.append("CREATE TABLE if not exists [sm_so_files] ( [customer_code] int NOT NULL, [so_prefix] int NOT NULL, [so_code] int NOT NULL, [file_code] int NOT NULL, [file_name] text NOT NULL, [file_url] text NOT NULL,[file_url_local] text NOT NULL, [file_custom_form_pk] text, PRIMARY KEY([customer_code],[so_prefix],[so_code],[file_code]));");
            ...
            script.append("CREATE TABLE if not exists [so_pack_expresss] ( [customer_code] int NOT NULL, [site_code] int NOT NULL, [operation_code] int NOT NULL, [product_code] int NOT NULL, [express_code] text NOT NULL COLLATE nocase, [pack_desc] text NOT NULL COLLATE nocase, PRIMARY KEY([customer_code],[site_code],[operation_code],[product_code],[express_code]));");
            script.append("CREATE TABLE if not exists [so_pack_expresss_local] ([customer_code] int NOT NULL, [site_code] int NOT NULL, [operation_code] int NOT NULL, [product_code] int NOT NULL, [express_code] text NOT NULL COLLATE nocase, [express_tmp] int NOT NULL, [serial_id] text NOT NULL COLLATE nocase, [partner_code] int NOT NULL, [so_prefix] int, [so_code] int, [so_desc] text COLLATE nocase, [so_status] text COLLATE nocase, [contract_code] int, [contract_desc] text COLLATE nocase, [priority_code] int, [priority_desc] text COLLATE nocase, [site_id] text COLLATE nocase, [site_desc] text COLLATE nocase, [operation_id] text COLLATE nocase, [operation_desc] text COLLATE nocase, [product_id] text COLLATE nocase, [product_desc] text COLLATE nocase, [serial_code] int, [segment_code] int, [segment_id] text COLLATE nocase, [segment_desc] text COLLATE nocase, [ret_code] text COLLATE nocase, [ret_msg] text COLLATE nocase, [status] text NOT NULL COLLATE nocase, [so_id] text COLLATE nocase, [log_date] text, [token] text not null default '' collate nocase, PRIMARY KEY([customer_code],[site_code],[operation_code], [product_code],[express_code],[express_tmp]));");
            ...
            script.append("create table if not exists [ge_custom_form_aps]([customer_code] int not null,[custom_form_type] int not null,[custom_form_type_desc] text not null COLLATE NOCASE,[custom_form_code] int not null,[custom_form_version] int not null,[custom_form_desc] text not null COLLATE NOCASE,[custom_form_data] text not null COLLATE NOCASE, [custom_form_url] text COLLATE NOCASE,[custom_form_url_local] text not null DEFAULT '' COLLATE NOCASE, [ap_code] int not null, [ap_description] text not null COLLATE NOCASE,[ap_status] text not null COLLATE NOCASE,[ap_comments] text COLLATE NOCASE,[ap_what] text COLLATE NOCASE,[ap_where] text COLLATE NOCASE,[ap_why] text COLLATE NOCASE,[ap_who] int, [ap_who_nick] text COLLATE NOCASE,[ap_how] text COLLATE NOCASE,[ap_how_much] text COLLATE NOCASE,[ap_when] text COLLATE NOCASE,[department_code] text COLLATE NOCASE,[department_id] text COLLATE NOCASE,[department_desc] text COLLATE NOCASE,[room_code] text COLLATE NOCASE,[ap_scn] int not null,[product_code] int not null,[product_id] text not null COLLATE NOCASE,[product_desc] text not null COLLATE NOCASE,[serial_code] int ,[serial_id] text COLLATE NOCASE,[sync_required] int not null default 0, [upload_required] int not null default 0,[last_update] text not null COLLATE NOCASE ,[create_date] text COLLATE NOCASE, [create_user] text COLLATE NOCASE, constraint pk_ge_custom_form_aps primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_data,ap_code));");
            //Tabelas IO
