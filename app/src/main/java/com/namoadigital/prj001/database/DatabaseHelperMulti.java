...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [ge_custom_form_aps]([customer_code] int not null,[custom_form_type] int not null,[custom_form_type_desc] text not null COLLATE NOCASE,[custom_form_code] int not null,[custom_form_version] int not null,[custom_form_desc] text not null COLLATE NOCASE,[custom_form_data] text not null COLLATE NOCASE, [custom_form_url] text COLLATE NOCASE,[custom_form_url_local] text not null DEFAULT '' COLLATE NOCASE, [ap_code] int not null, [ap_description] text not null COLLATE NOCASE,[ap_status] text not null COLLATE NOCASE,[ap_comments] text COLLATE NOCASE,[ap_what] text COLLATE NOCASE,[ap_where] text COLLATE NOCASE,[ap_why] text COLLATE NOCASE,[ap_who] int, [ap_who_nick] text COLLATE NOCASE,[ap_how] text COLLATE NOCASE,[ap_how_much] real,[ap_when] text COLLATE NOCASE,[department_code] text COLLATE NOCASE,[department_id] text COLLATE NOCASE,[department_desc] text COLLATE NOCASE,[room_code] text COLLATE NOCASE,[ap_scn] int not null,[product_code] int not null,[product_id] text not null COLLATE NOCASE,[product_desc] text not null COLLATE NOCASE,[serial_code] int ,[serial_id] text COLLATE NOCASE,[sync_required] int not null default 0, [upload_required] int not null default 0,[last_update] text not null COLLATE NOCASE , constraint pk_ge_custom_form_aps primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_data,ap_code));");
            //
