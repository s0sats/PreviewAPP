...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [ge_custom_form_fields] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [custom_form_seq] int not null, [custom_form_data_type] text not null COLLATE NOCASE, [custom_form_data_size] int, [custom_form_data_mask] text not null COLLATE NOCASE, [custom_form_data_content] text not null COLLATE NOCASE, [custom_form_local_link] text not null COLLATE NOCASE, [custom_form_order] int not null, [page] int not null, [required] int not null, constraint pk_form_fields primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_seq));");
            ...
            script.append("create table if not exists [ge_custom_form_blobs]([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [blob_code] int not null, [blob_name] text not null COLLATE NOCASE, [blob_url] text not null COLLATE NOCASE, [blob_url_local] text not null COLLATE NOCASE, constraint [pk_ge_custom_form_blobs] primary key([customer_code], [custom_form_type] , [custom_form_code] , [custom_form_version] , [blob_code]));");
