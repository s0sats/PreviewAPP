...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [ge_custom_form_fields_local] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [custom_form_data] int not null,[custom_form_data_serv] int not null, [custom_form_seq] int not null, [custom_form_data_type] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_size] int, [custom_form_data_mask] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_content] text not null DEFAULT '' COLLATE NOCASE, [custom_form_local_link] text not null DEFAULT '' COLLATE NOCASE, [custom_form_order] int not null, [page] int not null, [required] int not null, [automatic] text not null DEFAULT '' COLLATE NOCASE, [comment] text not null DEFAULT '' COLLATE NOCASE, [custom_form_field_desc] text not null DEFAULT '' COLLATE NOCASE, constraint pk_form_fields primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_data,custom_form_seq));");
