...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            //
            script.append("create table if not exists [sm_so_product_events] ([customer_code] int not null, [so_prefix] int not null, [so_code] int not null, [seq] int not null, [seq_tmp] int not null, [product_code] int not null , [product_id] text not null default '' collate nocase, [product_desc] text not null default '' collate nocase, [un] text not null default '' collate nocase,[flag_apply] int not null, [flag_repair] int not null, [flag_inspection] int not null, [qty_apply] int\t, [sketch_code] int,[sketch_name] text collate nocase, [sketch_url] text collate nocase, [sketch_url_local] text collate nocase,[sketch_lines] int, [sketch_columns] int, [sketch_color] text collate nocase,[comments] text collate nocase,[status] text collate nocase,constraint pk_sm_so_product_events primary key(customer_code, so_prefix, so_code, seq_tmp));");
