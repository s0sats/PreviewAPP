...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("CREATE TABLE if not exists [so_pack_expresss_local] ([customer_code] int NOT NULL, [site_code] int NOT NULL, [operation_code] int NOT NULL, [product_code] int NOT NULL, [express_code] text NOT NULL COLLATE nocase, [express_tmp] int NOT NULL, [serial_id] text NOT NULL COLLATE nocase, [partner_code] int NOT NULL, [so_prefix] int, [so_code] int, [so_desc] text COLLATE nocase, [so_status] text COLLATE nocase, [contract_code] int, [contract_desc] text COLLATE nocase, [priority_code] int, [priority_desc] text COLLATE nocase, [site_id] text COLLATE nocase, [site_desc] text COLLATE nocase, [operation_id] text COLLATE nocase, [operation_desc] text COLLATE nocase, [product_id] text COLLATE nocase, [product_desc] text COLLATE nocase, [serial_code] int, [segment_code] int, [segment_id] text COLLATE nocase, [segment_desc] text COLLATE nocase, [ret_code] text COLLATE nocase, [ret_msg] text COLLATE nocase, [status] NOT NULL COLLATE nocase, PRIMARY KEY([customer_code],[site_code],[operation_code], [product_code],[express_code],[express_tmp]));");
