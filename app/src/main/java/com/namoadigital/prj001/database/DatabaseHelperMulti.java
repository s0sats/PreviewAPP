...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("CREATE TABLE if not exists [sm_so_service_exec_task_files]( [customer_code] int NOT NULL, [so_prefix] int NOT NULL, [so_code] int NOT NULL, [price_list_code] int NOT NULL, [pack_code] int NOT NULL, [pack_seq] int NOT NULL, [category_price_code] int NOT NULL, [service_code] int NOT NULL, [service_seq] int NOT NULL, [exec_code] int, [task_code] int, [file_code] int, [exec_tmp] int NOT NULL, [task_tmp] int NOT NULL,[file_tmp] int NOT NULL, [file_name] text NOT NULL, [file_url] text NOT NULL,[file_url_local] text NOT NULL,PRIMARY KEY([customer_code] ,[so_prefix] ,[so_code] ,[price_list_code] ,[pack_code] ,[pack_seq] ,[category_price_code] ,[service_code] ,[service_seq] ,[exec_tmp] ,[task_tmp] ,[file_tmp]));");
