...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [ge_custom_forms] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [require_signature] int not null,constraint pk_forms primary key(customer_code,custom_form_type,custom_form_code,custom_form_version));");
            script.append("create table if not exists [ge_custom_form_fields] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [custom_form_seq] int not null, [custom_form_data_type] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_size] int, [custom_form_data_mask] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_content] text not null DEFAULT '' COLLATE NOCASE, [custom_form_local_link] text not null DEFAULT '' COLLATE NOCASE, [custom_form_order] int not null, [page] int not null, [required] int not null, [comment] text not null DEFAULT '' COLLATE NOCASE, constraint pk_form_fields primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_seq));");

            script.append("create table if not exists [ge_custom_forms_local]( [customer_code] int NOT NULL,  [custom_form_type] int NOT NULL,  [custom_form_code] int NOT NULL,  [custom_form_version] int NOT NULL,  [custom_form_data] int NOT NULL,  [custom_form_pre] text NOT NULL DEFAULT '' COLLATE nocase,  [custom_form_status] text NOT NULL DEFAULT '' COLLATE nocase,  [custom_form_src] text NOT NULL DEFAULT '' COLLATE nocase,  [custom_product_code] int NOT NULL,  [custom_product_desc] text NOT NULL DEFAULT '' COLLATE nocase,  [custom_form_type_desc] text NOT NULL DEFAULT '' COLLATE nocase,  [custom_form_desc] text NOT NULL DEFAULT '' COLLATE nocase,  [require_signature] int NOT NULL,  CONSTRAINT [pk_forms] PRIMARY KEY([customer_code], [custom_form_type], [custom_form_code], [custom_form_version], [custom_form_data]));  ");
            script.append("create table if not exists [ge_custom_form_fields_local] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [custom_form_data] int not null, [custom_form_seq] int not null, [custom_form_data_type] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_size] int, [custom_form_data_mask] text not null DEFAULT '' COLLATE NOCASE, [custom_form_data_content] text not null DEFAULT '' COLLATE NOCASE, [custom_form_local_link] text not null DEFAULT '' COLLATE NOCASE, [custom_form_order] int not null, [page] int not null, [required] int not null, [comment] text not null DEFAULT '' COLLATE NOCASE, [custom_form_field_desc] text not null DEFAULT '' COLLATE NOCASE, constraint pk_form_fields primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_data,custom_form_seq));");
            ...
            script.append("create table if not exists [ge_custom_form_datas]( [customer_code] int NOT NULL, [custom_form_type] int NOT NULL, [custom_form_code] int NOT NULL, [custom_form_version] int NOT NULL, [custom_form_data] int NOT NULL, [custom_form_status] text NOT NULL DEFAULT '' COLLATE nocase, [product_code] int NOT NULL, [serial_id] text NOT NULL DEFAULT '' COLLATE nocase, [date_start] text NOT NULL DEFAULT '' COLLATE nocase, [date_end] text NOT NULL DEFAULT '' COLLATE nocase, [user_code] int NOT NULL, [site_code] int NOT NULL, [operation_code] int NOT NULL, [signature] text DEFAULT '' COLLATE NOCASE, [token] text NOT NULL DEFAULT '' COLLATE nocase, CONSTRAINT [pk_forms] PRIMARY KEY([customer_code], [custom_form_type], [custom_form_code], [custom_form_version], [custom_form_data]));");
            script.append("create table if not exists [ge_custom_form_data_fields] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [custom_form_data] int not null, [custom_form_seq] int not null,[value] text not null DEFAULT '' COLLATE NOCASE, [value_extra] text not null DEFAULT '' COLLATE NOCASE, constraint pk_forms primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_data,custom_form_seq));");
