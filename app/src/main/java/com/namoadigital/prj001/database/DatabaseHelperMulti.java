...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [ge_custom_form_datas] ([customer_code] int not null, [custom_form_type] int not null, [custom_form_code] int not null, [custom_form_version] int not null, [custom_form_data] int not null,[custom_form_status] text not null DEFAULT '' COLLATE NOCASE, [product_code] int not null, [serial_id] text not null DEFAULT '' COLLATE NOCASE,[date_start] text not null DEFAULT '' COLLATE NOCASE, [date_end] text not null DEFAULT '' COLLATE NOCASE, [user_code_start] int not null, [user_code_end] int not null, [token] text not null DEFAULT '' COLLATE NOCASE, constraint pk_forms primary key(customer_code,custom_form_type,custom_form_code,custom_form_version,custom_form_data));");
