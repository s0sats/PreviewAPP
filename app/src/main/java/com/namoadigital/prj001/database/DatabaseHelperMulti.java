...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("create table if not exists [md_products] ([customer_code] int not null, [product_code] int not null, [product_id] text not null DEFAULT '' COLLATE NOCASE, [product_desc] text not null DEFAULT '' COLLATE NOCASE, [require_serial] int not null, [allow_new_serial_cl] int not null, [un] text COLLATE nocase, [sketch_code] int, [sketch_url] text COLLATE nocase, [sketch_url_local] text not null DEFAULT '' COLLATE nocase,[sketch_lines] int, [sketch_columns] int, [sketch_color] text COLLATE nocase,[flag_offline] int not null default 0,[local_control] int not null default 0, [io_control] int not null default 0, [serial_rule] text collate nocase, [serial_min_length] int, [serial_max_length] int, constraint pk_md_products primary key(customer_code, product_code));");
            ...
            script.append("create table if not exists [md_sites] ([customer_code] int not null, [site_code] int not null, [site_id] text not null DEFAULT '' COLLATE NOCASE,  [site_desc] text not null DEFAULT '' COLLATE NOCASE, [io_control] int not null default 0,constraint pk_md_sites primary key(customer_code, site_code));");
