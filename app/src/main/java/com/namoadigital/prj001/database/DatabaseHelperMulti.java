...
public class DatabaseHelperMulti extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            script.append("CREATE TABLE if not exists [so_pack_expresss] ( [customer_code] int NOT NULL, [site_code] int NOT NULL, [operation_code] int NOT NULL,  [express_code] text NOT NULL COLLATE nocase, [pack_desc] text NOT NULL COLLATE nocase, [product_code] int NOT NULL, PRIMARY KEY([customer_code],[site_code],[operation_code],[express_code],[product_code]));");
            script.append("CREATE TABLE if not exists [so_pack_expresss_local] ( [customer_code] int NOT NULL, [site_code] int NOT NULL, [operation_code] int NOT NULL,  [express_code] text NOT NULL COLLATE nocase, [pack_desc] text NOT NULL COLLATE nocase, [product_code] int NOT NULL, [express_tmp] int NOT NULL, [partner_code]  int NOT NULL, PRIMARY KEY([customer_code],[site_code],[operation_code],[express_code],[product_code],[express_tmp]));");
