...
public class T_TK_Ticket_Checkin_Rec {
    ...
    @SerializedName("ticket") private ArrayList<T_TK_Ticket_WS_Return> ticket = new ArrayList<>();
    ...
    public ArrayList<T_TK_Ticket_WS_Return> getTicket() {
        return ticket;
    }

    public void setTicket(ArrayList<T_TK_Ticket_WS_Return> ticket) {
        this.ticket = ticket;
    }
}
