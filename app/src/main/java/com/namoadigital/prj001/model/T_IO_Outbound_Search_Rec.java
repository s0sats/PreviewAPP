...
public class T_IO_Outbound_Search_Rec {
    ...
    @SerializedName("record") private ArrayList<IO_Outbound_Search_Record> record;
    ...
    public ArrayList<IO_Outbound_Search_Record> getRecord() {
        return record;
    }

    public void setRecord(ArrayList<IO_Outbound_Search_Record> record) {
        this.record = record;
    }
