...
public class SO_Creation_Obj implements Serializable {
    ...
    @SerializedName("so_scn") private Integer so_scn;
    ...
    @SerializedName("priority_code") private Integer priority_code;
    ...
    @SerializedName("client_type") private String client_type;
    @SerializedName("pack_default") private String pack_default;
    ...
    @SerializedName("billing_add_inf1") private String billing_add_inf1;
    @SerializedName("billing_add_inf2") private String billing_add_inf2;
    @SerializedName("billing_add_inf3") private String billing_add_inf3;
    @SerializedName("add_inf1_tracking") private int add_inf1_tracking;
    @SerializedName("add_inf2_tracking") private int add_inf2_tracking;
    @SerializedName("add_inf3_tracking") private int add_inf3_tracking;
    @SerializedName("add_inf4_tracking") private int add_inf4_tracking;
    @SerializedName("add_inf5_tracking") private int add_inf5_tracking;
    @SerializedName("add_inf6_tracking") private int add_inf6_tracking;
    ...
    @SerializedName("edit_user") private int edit_user;
    @SerializedName("price_list_code") private Integer price_list_code;
    @SerializedName("pack_code") private Integer pack_code;
    @SerializedName("pack_service_desc_full") private String pack_service_desc_full;
    @SerializedName("po_code") private Integer po_code;
    @SerializedName("site_exec") private int site_exec;
    @SerializedName("fullVision") private boolean fullVision;
