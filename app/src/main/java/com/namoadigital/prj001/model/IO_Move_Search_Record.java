...
public class IO_Move_Search_Record {
    ...
    public String getPlanned_zone_id() {
        return planned_zone_id;
    }

    public void setPlanned_zone_id(String planned_zone_id) {
        this.planned_zone_id = planned_zone_id;
    }

    public String getPlanned_zone_desc() {
        return planned_zone_desc;
    }

    public void setPlanned_zone_desc(String planned_zone_desc) {
        this.planned_zone_desc = planned_zone_desc;
    }

    public String getPlanned_local_id() {
        return planned_local_id;
    }

    public void setPlanned_local_id(String planned_local_id) {
        this.planned_local_id = planned_local_id;
    }
