...
class GeOsDeviceItem(
    ...
    companion object{
        ...
        const val ITEM_CHECK_STATUS_LIMIT_DATE_REACHED = "LIMIT_DATE_REACHED" //LIMIT_DATE_REACHED -> VOLTAR PARA NORMAL
        const val ITEM_CHECK_STATUS_PROJECTED_DATE_REACHED = "PROJECTED_DATE_REACHED" //PROJECTED_DATE_REACHED -> VOLTAR PARA NORMAL
        const val ITEM_CHECK_STATUS_MEASURE_ALERT = "MEASURE_ALERT" //MEASURE_ALERT -> VOLTAR PARA NORMAL
        ...
        const val ITEM_CHECK_STATUS_MANUALLY_FORCED_ITEM = "MANUALLY_FORCED_ITEM" // MANUALLY_FORCED_ITEM
        const val ITEM_CHECK_STATUS_MANUALLY_FORCED_DATE = "MANUALLY_FORCED_DATE" // MANUALLY_FORCED_DATE   -> VOLTAR PARA NORMAL
        //
