...
public class ConstantBaseApp extends ConstantBase {
    ...
    public static final String ACT057 = "act057";
    public static final String ACT058 = "act058";
    ...
    public static final String SO_EXPRESS_STATUS_NEW = "NEW";
    ...
    public static final String IO_SERIAL_EDIT = "SERIAL_EDIT";
    ...
    public static final String PREFERENCE_HOME_FOCUS_FILTER = "PREFERENCE_HOME_FOCUS_FILTER";
    public static final String PREFERENCE_HOME_ONLY_MY_ACTIONS_OPTION = "PREFERENCE_HOME_ONLY_MY_ACTIONS_OPTION";
    public static final String PREFERENCE_HOME_ALL_ACTIONS_OPTION = "PREFERENCE_HOME_ALL_ACTIONS_OPTION";
    ...
    public static final int TIMEOUT_FOR_SYNC_FORM = 300000;
