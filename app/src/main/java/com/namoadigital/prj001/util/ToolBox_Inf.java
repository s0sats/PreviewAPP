...
//                                formProductDao
//                        ).toSqlQuery()
//                ).get(hasFormXProduct.FORM_OPERATION_PROFILE);
...
//    }
    ...
    public static boolean checkFormXOperationExists(Context context, long customer_code,long product_code,long operation_code){
    ...
    public static boolean checkFormXSiteExists(Context context, long customer_code,long product_code,String site_code){
        ...
        String hasFormXSite =
                ...
                ).get(Sql_Form_x_Site.FORM_SITE_PROFILE);
