...
public class MD_PartnerDao extends BaseDao implements Dao<MD_Partner> {
    ...
    public MD_PartnerDao(Context context) {
        super(context, ToolBox_Con.customDBPath(ToolBox_Con.getPreference_Customer_Code(context)), Constant.DB_VERSION_CUSTOM, Constant.DB_MODE_MULTI);
