...
public class CH_RoomDao extends BaseDao implements Dao<CH_Room> {
    ...
    public static String[] columns = {
            ...
            USER_CODE, ROOM_STATUS, STATUS_UPDATE
    ...
    public List<HMAux> query_HM(String sQuery) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ch_rooms.add(CursorToHMAuxMapper.mapN(cursor));
            }
    ...
    private class CursortoCH_RoomMapper implements Mapper<Cursor, CH_Room> {
        ...
        public CH_Room map(Cursor cursor) {
            ...
            if (!cursor.isNull(cursor.getColumnIndex(ROOM_STATUS))) {
                ch_room.setRoom_status(cursor.getString(cursor.getColumnIndex(ROOM_STATUS)));
            } else {
                ch_room.setRoom_status(null);
            }
            //
    ...
    private class CH_RoomtoContentValuesMapper implements Mapper<CH_Room, ContentValues> {
        ...
        public ContentValues map(CH_Room ch_room) {
            ...
            contentValues.put(ROOM_STATUS, ch_room.getRoom_status());
