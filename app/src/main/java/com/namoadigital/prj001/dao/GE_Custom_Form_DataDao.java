...
//        return custom_form_data;
    ...
    public List<HMAux> query_HM(String s_query) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                custom_form_datas.add(CursorToHMAuxMapper.mapN(cursor));
            }
        ...
        public GE_Custom_Form_Data map(Cursor cursor) {
            ...
            */
            ...
            if (cursor.isNull(cursor.getColumnIndex(CUSTOM_FORM_VERSION_PARTITION))) {
                custom_form_data.setCustom_form_version_partition(null);
            } else {
                custom_form_data.setCustom_form_version_partition(cursor.getInt(cursor.getColumnIndex(CUSTOM_FORM_VERSION_PARTITION)));
            }
    ...
    private class GE_Custom_Form_DataToContentValuesMapper implements Mapper<GE_Custom_Form_Data, ContentValues> {
        ...
        public ContentValues map(GE_Custom_Form_Data custom_form_data) {
            ...
            */
            ...
            //
            contentValues.put(TICKET_PREFIX, custom_form_data.getTicket_prefix());
