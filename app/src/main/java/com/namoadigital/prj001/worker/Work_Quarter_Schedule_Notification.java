...
public class Work_Quarter_Schedule_Notification extends Worker {
    public static final String WORKER_TAG = "Work_Quarter_Schedule_Notification";

    public Work_Quarter_Schedule_Notification(@NonNull Context context, @NonNull WorkerParameters workerParams) {
