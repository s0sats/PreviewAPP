...
public class Act049_Main extends Base_Activity_Frag implements Act049_Main_Contract.I_View {

    private Bundle bundle;
    private Act049_Main_Contract.I_Presenter mPresenter;
    ...
    private void initVars() {
        recoverIntentsInfo();
        //
        mPresenter = new Act049_Main_Presenter(
                context,
                this,
                bundle_product_code,
                hmAux_Trans,
    ...
    private void initFrag() {
        frgSerialEdit = (Frg_Serial_Edit) fm.findFragmentById(R.id.act049_frg_serial_edit);
        ...
        frgSerialEdit.setDelegate(new Frg_Serial_Edit.I_Frg_Serial_Edit() {
                ...
                public void onSaveWithChangesClick(MD_Product_Serial md_product_serial, boolean serial_id_changes) {
                    mPresenter.updateSerialData(md_product_serial);
                    //
                    mdProductSerial = md_product_serial;
                    //
                    if(ToolBox_Con.isOnline(context)) {
    ...
    public void callAct040(Context context) {
        ...
        mBundle.putLong(SO_Pack_Express_LocalDao.EXPRESS_TMP,bundle.getLong(SO_Pack_Express_LocalDao.EXPRESS_TMP, -1));
        //
