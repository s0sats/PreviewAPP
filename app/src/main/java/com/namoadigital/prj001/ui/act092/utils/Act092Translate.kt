...
object Act092Translate {
    ...
    const val ALERT_SEND_FINISH_MSG = "alert_send_finish_msg"
    const val DIALOG_DOWNLOAD_TICKET_TTL = "dialog_download_ticket_ttl"
    const val DIALOG_DOWNLOAD_TICKET_START = "dialog_download_ticket_start"
    const val ALERT_FREE_EXECUTION_BLOCKED_TTL = "alert_free_execution_blocked_ttl"
    const val ALERT_FREE_EXECUTION_BLOCKED_MSG = "alert_free_execution_blocked_msg"


    const val PROGRESS_SYNC_TTL = "progress_sync_ttl"
    const val PROGRESS_SYNC_MSG = "progress_sync_msg"


    const val ALERT_NO_FORM_TTL = "alert_no_form_ttl"
    const val ALERT_PRODUCT_OR_SERIAL_NOT_FOUND_TTL = "alert_product_or_serial_not_found_ttl"
    const val ALERT_PRODUCT_OR_SERIAL_NOT_FOUND_MSG = "alert_product_or_serial_not_found_msg"

    //validate Form
    const val ALERT_NO_FORM_MSG = "alert_no_form_msg"
    const val ALERT_NO_FORM_PRODUCT_MSG = "alert_no_form_for_product_msg"
