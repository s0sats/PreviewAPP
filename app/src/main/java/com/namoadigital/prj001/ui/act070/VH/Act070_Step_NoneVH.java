...
public class Act070_Step_NoneVH extends Act070_Step_Abstract_ProcessVH {
    ...
    public Act070_Step_NoneVH(Context context, @NonNull View itemView, Act070_Steps_Adapter.OnNoneClickListener noneClickListener, String transStartProcess, String transReviewProcess,String transContinueProcess, String transWaitingSync, boolean isInWgEditMode) {
