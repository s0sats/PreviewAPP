...
public class Act060_Main extends Base_Activity_Frag implements Act060_Main_Contract.I_View, Frag_Move_Create.OnFragmentInteractionListener {
    ...
    private IO_Outbound io_outbound;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act060_main);
    ...
    private void recoverIntentsInfo() {
        ...
        if (bundle != null) {
            io_prefix = Integer.valueOf(bundle.getString(IO_Outbound_ItemDao.OUTBOUND_PREFIX));
            io_code = Integer.valueOf(bundle.getString(IO_Outbound_ItemDao.OUTBOUND_CODE));
            has_picking = bundle.getInt(IO_OutboundDao.PICKING_PROCESS);
            zone_code_picking = bundle.getInt(IO_OutboundDao.ZONE_CODE_PICKING, -1);
            local_code_picking = bundle.getInt(IO_OutboundDao.LOCAL_CODE_PICKING, -1);
            try {
                io_item = Integer.valueOf(bundle.getString(IO_Outbound_ItemDao.OUTBOUND_ITEM));
            } catch (Exception e) {
                e.printStackTrace();
                io_item = null;
            }
    ...
    private <T extends BaseFragment> void setFrag(T type, String sTag) {
        if (fm.findFragmentByTag(sTag) == null) {
            ...
            ft.replace(R.id.act060_frg_placeholder, type, sTag);
    ...
    private void initVars() {
        ...
        frag_move_create = Frag_Move_Create.newInstance(
                ...
                -1,
                null,
                ConstantBaseApp.IO_PROCESS_OUT_CONF,
                planned_zone_code,
                outbound_prefix,
                inbound_prefix,
                outbound_code,
    ...
    private void iniUIFooter() {
        ...
        mAct_Title = Constant.ACT060 + "_" + "title";
        //
    ...
    protected void processCloseACT(String mLink, String mRequired, HMAux hmAux) {
        ...
        } else if (ws_process.equals(WS_IO_Outbound_Item_Save.class.getName())) {
            Gson gsonParser = new GsonBuilder().serializeNulls().create();
            ArrayList<WS_IO_Outbound_Item_Save.OutboundItemSaveActReturn> actReturnList
    ...
    private void showResults(ArrayList<WS_IO_Outbound_Item_Save.OutboundItemSaveActReturn> actReturnList) {
        ArrayList<HMAux> resultList = new ArrayList<>();
        for (WS_IO_Outbound_Item_Save.OutboundItemSaveActReturn result : actReturnList) {
            HMAux aux = new HMAux();
            String itemPk;
...
//        bundle.putString(MD_Product_SerialDao.SERIAL_ID, String.valueOf(serialInfo.getSerial_id()));
        bundle.putString(ConstantBaseApp.MAIN_REQUESTING_ACT, Constant.ACT060);
